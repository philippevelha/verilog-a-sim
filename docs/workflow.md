...
`gmin` rescue, which a large compiled-model `.op` can. `docs/validation.md` §"The circuit-size
limit" has the calibration tables, the dense/sparse crossover, and what to do when the estimate
says minutes.
